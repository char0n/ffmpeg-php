<?php
/**
 * \FFmpegPHP\Adapter\ffmpeg_movie serves as a compatibility Adapter for old ffmpeg-php extension.
 * 
...
namespace FFmpegPHP\Adapter {
    ...
    use \FFmpegPHP\Movie;
    use \FFmpegPHP\Provider\FFmpeg\OutputProvider;
    ...
    class ffmpeg_movie {
        ...
        public function __construct($moviePath, $persistent = false) {
            $this->adaptee = new Movie($moviePath, new OutputProvider('ffmpeg', $persistent));
        }
